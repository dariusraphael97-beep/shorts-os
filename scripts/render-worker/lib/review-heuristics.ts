// scripts/render-worker/lib/review-heuristics.ts
//
// Copied from src/lib/agents/review/{verdict,components}.ts — worker can't
// import src/*; keep in sync.
//
// Pure deterministic review scoring helpers. No I/O, no LLM, no randomness,
// no Date calls. Logic is byte-for-byte equivalent to the source modules.

// ---------------------------------------------------------------------------
// Shared types (from verdict.ts + components.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Internal helpers (from components.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// scoreDescriptionSeo (from components.ts)
// ---------------------------------------------------------------------------
//
...
// ---------------------------------------------------------------------------
// scoreHookFromTranscript (from components.ts)
// ---------------------------------------------------------------------------
//
// Scoring formula:
//
