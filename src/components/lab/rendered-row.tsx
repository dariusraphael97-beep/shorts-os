    ...
    <li className="px-4 py-4 space-y-3">
      ...
      {video.render_artifact_url ? (
        <video
          ...
          controls
          playsInline
          className="w-full max-w-xs rounded border border-[var(--border-subtle)] bg-black"
          style={{ aspectRatio: "9 / 16" }}
        />
      ) : (
        <p className="text-xs text-[var(--text-muted)]">No render_artifact_url; cannot preview.</p>
      )}
